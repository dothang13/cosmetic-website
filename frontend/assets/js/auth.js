...
// === 2. XỬ LÝ ĐĂNG KÝ (Cần viết thêm API Đăng ký ở Backend sau này) ===
...
if (registerForm) {
  registerForm.addEventListener("submit", function (e) {
    ...
    // Tạm thời báo lỗi vì chưa có Backend cho phần Đăng ký
    alert("Chức năng đang phát triển (Cần viết thêm API Register ở Backend)");

    // --- Gợi ý code sau này khi đã có API ---
    /*
