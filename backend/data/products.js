...
// Dữ liệu y hệt file db.js của đồng nghiệp
const productsDB = [
  {
    id: 1,
    ...
    price: 150000,
    image:
      "https://images.unsplash.com/photo-1586495777744-4413f21062fa?q=80&w=2030",
    category: "Son môi",
  ...
  },
  {
    ...
    price: 320000,
    image:
      "https://images.unsplash.com/photo-1631729371254-42c2892f0e6e?q=80&w=2070",
  ...
  },
  {
    ...
    price: 250000,
    image:
      "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?q=80&w=1887",
    category: "Chăm sóc da",
    desc: "Cân bằng độ pH cho da, se khít lỗ chân lông, không chứa cồn.",
  },
];

module.exports = productsDB; // Xuất dữ liệu để file khác dùng
